      ...
      <xsl:choose>
        ...
        <xsl:when test="$taldeParam = ''">
          <div class="w3-row-padding w3-margin-top"
            style="width: 100%; max-width: 1200px; display: flex; flex-wrap: wrap; justify-content: center;">
        ...
        <xsl:otherwise>
          ...
          <div class="w3-margin-bottom w3-margin-top">
            <xsl:choose>
              <xsl:when test="$origenParam = 'sailkapena'">
                <a href="sailkapena.php" class="w3-button w3-round-large w3-hover-red"
                  style="background-color:#871521; color:white; text-decoration:none;">
                  Bueltatu (Sailkapena)
                </a>
              </xsl:when>
              <xsl:otherwise>
                <a href="taldeak.php" class="w3-button w3-round-large w3-hover-red"
                  style="background-color:#871521; color:white; text-decoration:none;">
          ...
          <xsl:for-each
            select="Federazioa/TaldeGuztiak/Talde[Izena = $taldeParam]">
            <div class="w3-card-4 w3-margin-bottom w3-white w3-round-large w3-overflow-hidden"
              ...
              <div class="w3-container w3-padding-24">
                <div class="w3-row"
                  style="display: flex; flex-wrap: wrap; align-items: center; gap: 20px; justify-content: space-between;">
                  ...
                  <div class="w3-col m8">
                    <h4 class="w3-border-bottom w3-padding-16" style="margin-top: 0; color: #333;">
    Jokalariak</h4>
